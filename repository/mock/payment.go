...
func (m *MockPaymentRepository) GetPayments(ctx context.Context) ([]model.Payment, error) {
	m.ctrl.T.Helper()
...
func (mr *MockPaymentRepositoryMockRecorder) GetPayments(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
